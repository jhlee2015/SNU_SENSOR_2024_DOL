            ...
            try:
                while True:
                    ...
                    if read_result.isError():
                        ...
                        #modbus 통신 테스트용
                        mclient.modbus_tcp_client.write_modbus_float(serial_logger, self.tcp_client, 1, round(123.45, 2))
                    else:
